...
/**
 * @brief Parse a TIFF tag entry into its target C++ representation (with endianess conversion)
 *
 ...
 *  For instance: main type is LONG8, alternate types are SHORT, LONG
 *
