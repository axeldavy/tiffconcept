...
template <TagCode Code, TiffDataType Type, typename ValueType, bool Optional>
struct tag_value_type<TagDescriptor<Code, Type, ValueType, Optional>> {
...
template <TagCode Code, TiffDataType Type, typename ValueType, bool Optional>
struct tag_storage_type<TagDescriptor<Code, Type, ValueType, Optional>> {
    using type = typename TagDescriptor<Code, Type, ValueType, Optional>::storage_type;
};
...
template <TagCode Code, typename... Tags>
inline constexpr bool has_tag_v = has_tag<Code, Tags...>::value;
...
struct TagSpec {
    ...
    static constexpr bool has_tag() noexcept {
        return has_tag_v<Code, Tags...>;
    }

    /// Check if a tag code is supported (compile-time constant)
    template <TagCode Code>
    static constexpr bool has_tag_v = ((Tags::code == Code) || ...);
...
concept ValidTagSpec = requires {
    ...
    // Must be instantiation of TagSpec template
    requires []<TagDescriptorType... Tags>(TagSpec<Tags...>*) {
        return std::is_same_v<std::remove_cvref_t<T>, TagSpec<Tags...>>;
...
using BitsPerSampleTag = TagDescriptor<TagCode::BitsPerSample, TiffDataType::Short, uint16_t, false>; // Default: 1
...
using XResolutionTag = TagDescriptor<TagCode::XResolution, TiffDataType::Rational, std::pair<uint32_t, uint32_t>, false>;
using YResolutionTag = TagDescriptor<TagCode::YResolution, TiffDataType::Rational, std::pair<uint32_t, uint32_t>, false>;
...
using XPositionTag = TagDescriptor<TagCode::XPosition, TiffDataType::Rational, std::pair<uint32_t, uint32_t>, false>;
using YPositionTag = TagDescriptor<TagCode::YPosition, TiffDataType::Rational, std::pair<uint32_t, uint32_t>, false>;
...
using PageNumberTag = TagDescriptor<TagCode::PageNumber, TiffDataType::Short, std::pair<uint16_t, uint16_t>, false>;
...
using WhitePointTag = TagDescriptor<TagCode::WhitePoint, TiffDataType::Rational, std::array<std::pair<uint32_t, uint32_t>, 2>, false>;
using PrimaryChromaticitiesTag = TagDescriptor<TagCode::PrimaryChromaticities, TiffDataType::Rational, std::array<std::pair<uint32_t, uint32_t>, 6>, false>;
using ColorMapTag = TagDescriptor<TagCode::ColorMap, TiffDataType::Short, std::vector<uint16_t>, false>;
using HalftoneHintsTag = TagDescriptor<TagCode::HalftoneHints, TiffDataType::Short, std::pair<uint16_t, uint16_t>, false>;
...
using DecodeTag = TagDescriptor<TagCode::Decode, TiffDataType::SRational, std::vector<std::pair<int32_t, int32_t>>, false>;
...
// YCbCr tags
using YCbCrCoefficientsTag = TagDescriptor<TagCode::YCbCrCoefficients, TiffDataType::Rational, std::array<std::pair<uint32_t, uint32_t>, 3>, false>;
using YCbCrSubSamplingTag = TagDescriptor<TagCode::YCbCrSubSampling, TiffDataType::Short, std::pair<uint16_t, uint16_t>, false>; // Default: [2,2]
...
using BlackLevelRepeatDimTag = TagDescriptor<TagCode::BlackLevelRepeatDim, TiffDataType::Short, std::pair<uint16_t, uint16_t>, false>;
using BlackLevelTag = TagDescriptor<TagCode::BlackLevel, TiffDataType::Rational, std::vector<std::pair<uint32_t, uint32_t>>, false>;
using BlackLevelDeltaHTag = TagDescriptor<TagCode::BlackLevelDeltaH, TiffDataType::SRational, std::vector<std::pair<int32_t, int32_t>>, false>;
using BlackLevelDeltaVTag = TagDescriptor<TagCode::BlackLevelDeltaV, TiffDataType::SRational, std::vector<std::pair<int32_t, int32_t>>, false>;
using WhiteLevelTag = TagDescriptor<TagCode::WhiteLevel, TiffDataType::Long, std::vector<uint32_t>, false>;
using DefaultScaleTag = TagDescriptor<TagCode::DefaultScale, TiffDataType::Rational, std::pair<std::pair<uint32_t, uint32_t>, std::pair<uint32_t, uint32_t>>, false>;
using DefaultCropOriginTag = TagDescriptor<TagCode::DefaultCropOrigin, TiffDataType::Rational, std::pair<std::pair<uint32_t, uint32_t>, std::pair<uint32_t, uint32_t>>, false>;
using DefaultCropSizeTag = TagDescriptor<TagCode::DefaultCropSize, TiffDataType::Rational, std::pair<std::pair<uint32_t, uint32_t>, std::pair<uint32_t, uint32_t>>, false>;
using ColorMatrix1Tag = TagDescriptor<TagCode::ColorMatrix1, TiffDataType::SRational, std::vector<std::pair<int32_t, int32_t>>, false>;
using ColorMatrix2Tag = TagDescriptor<TagCode::ColorMatrix2, TiffDataType::SRational, std::vector<std::pair<int32_t, int32_t>>, false>;
using CameraCalibration1Tag = TagDescriptor<TagCode::CameraCalibration1, TiffDataType::SRational, std::vector<std::pair<int32_t, int32_t>>, false>;
using CameraCalibration2Tag = TagDescriptor<TagCode::CameraCalibration2, TiffDataType::SRational, std::vector<std::pair<int32_t, int32_t>>, false>;
using ReductionMatrix1Tag = TagDescriptor<TagCode::ReductionMatrix1, TiffDataType::SRational, std::vector<std::pair<int32_t, int32_t>>, false>;
using ReductionMatrix2Tag = TagDescriptor<TagCode::ReductionMatrix2, TiffDataType::SRational, std::vector<std::pair<int32_t, int32_t>>, false>;
using AnalogBalanceTag = TagDescriptor<TagCode::AnalogBalance, TiffDataType::Rational, std::vector<std::pair<uint32_t, uint32_t>>, false>;
using AsShotNeutralTag = TagDescriptor<TagCode::AsShotNeutral, TiffDataType::Rational, std::vector<std::pair<uint32_t, uint32_t>>, false>;
using AsShotWhiteXYTag = TagDescriptor<TagCode::AsShotWhiteXY, TiffDataType::Rational, std::pair<std::pair<uint32_t, uint32_t>, std::pair<uint32_t, uint32_t>>, false>;
using BaselineExposureTag = TagDescriptor<TagCode::BaselineExposure, TiffDataType::SRational, std::pair<int32_t, int32_t>, false>;
using BaselineNoiseTag = TagDescriptor<TagCode::BaselineNoise, TiffDataType::Rational, std::pair<uint32_t, uint32_t>, false>;
using BaselineSharpnessTag = TagDescriptor<TagCode::BaselineSharpness, TiffDataType::Rational, std::pair<uint32_t, uint32_t>, false>;
using BayerGreenSplitTag = TagDescriptor<TagCode::BayerGreenSplit, TiffDataType::Long, uint32_t, false>;
using LinearResponseLimitTag = TagDescriptor<TagCode::LinearResponseLimit, TiffDataType::Rational, std::pair<uint32_t, uint32_t>, false>;
using CameraSerialNumberTag = TagDescriptor<TagCode::CameraSerialNumber, TiffDataType::Ascii, std::string, false>;
using LensInfoTag = TagDescriptor<TagCode::LensInfo, TiffDataType::Rational, std::array<std::pair<uint32_t, uint32_t>, 4>, false>;
using ChromaBlurRadiusTag = TagDescriptor<TagCode::ChromaBlurRadius, TiffDataType::Rational, std::pair<uint32_t, uint32_t>, false>;
using AntiAliasStrengthTag = TagDescriptor<TagCode::AntiAliasStrength, TiffDataType::Rational, std::pair<uint32_t, uint32_t>, false>;
using ShadowScaleTag = TagDescriptor<TagCode::ShadowScale, TiffDataType::Rational, std::pair<uint32_t, uint32_t>, false>;
...
using BestQualityScaleTag = TagDescriptor<TagCode::BestQualityScale, TiffDataType::Rational, std::pair<uint32_t, uint32_t>, false>;
...
using AsShotPreProfileMatrixTag = TagDescriptor<TagCode::AsShotPreProfileMatrix, TiffDataType::SRational, std::vector<std::pair<int32_t, int32_t>>, false>;
using CurrentICCProfileTag = TagDescriptor<TagCode::CurrentICCProfile, TiffDataType::Undefined, std::vector<uint8_t>, false>;
using CurrentPreProfileMatrixTag = TagDescriptor<TagCode::CurrentPreProfileMatrix, TiffDataType::SRational, std::vector<std::pair<int32_t, int32_t>>, false>;
